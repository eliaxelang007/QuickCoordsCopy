...
public class QuickCoordsCopyClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        final var DEFAULT_COORDS_FORMAT = "$x, $y, $z";
        final var COORDS_FORMAT_KEY = "formatting";
        final var DEFAULT_CONFIG = COORDS_FORMAT_KEY + "=" + DEFAULT_COORDS_FORMAT;

        final var config = SimpleConfig
            .of("quickcoordscopy")
            .provider((namespace) -> DEFAULT_CONFIG)
            .request();

        final var copyCoordsKey = KeyBindingHelper
            .registerKeyBinding(
                    new KeyBinding(
